...
from flask import Flask, render_template, request, make_response, session, abort, jsonify
from flask_login import LoginManager, login_user, login_required, logout_user, current_user
from flask_restful import Api
from flask_ngrok import run_with_ngrok
from werkzeug.utils import redirect

from first_blog.data import User, News, news_api, db_session, NewsListResource, NewsResource
...
def index():
    ...
    res.set_cookie("visits_count", '1', max_age=10)
    return res
